...
function DoctorsList() {
    ...
    return (
        ...
        <ScrollArea className="w-full  h-fit rounded-md border p-9 ">

            <h1 className="mb-4 text-sm font-medium leading-none">Doctors</h1>
            {doctors.map((doctor, index) => (
                < >
                    <div key={index} className="grid  grid-cols-2 justify-around items-center hover:bg-blue-200 rounded-lg">
